...
apt install xorg pipewire pipewire-pulse pipewire-alsa alsa-utils xmonad libghc-xmonad-contrib-dev libghc-xmonad-dev xmobar i3lock steam gimp inkscape xfce4-settings thunderbird firefox-esr alacritty thunar vim git unzip shotwell celluloid rofi lightdm feh picom xinput maim xclip xdotool libsdl2-2.0-0 libsdl2-dev libsdl2-image-2.0-0 libsdl2-image-dev libsdl2-ttf-2.0-0 libsdl2-ttf-dev libsdl2-mixer-2.0-0 libsdl2-mixer-dev gtk2-engines-murrine gtk2-engines-pixbuf rhythmbox xautolock htop libavcodec-extra playerctl gnome-disk-utility gufw enpass libreoffice-calc libreoffice-writer libreoffice-gtk3 printer-driver-hpcups hplip gamemode openvpn openssl openresolv transmission-gtk rsync timeshift pavucontrol gdb flatpak galculator mousepad python3.11-venv thunar-archive-plugin neovim ./Minecraft.deb -y
